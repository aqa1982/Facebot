...
def qaiserallinone():
    ...
    if pepek == '':
        ...
        print
        '1. Credit To All The Commands Author'
        time.sleep(4)
        print
        "2. SPECIAL THANKS TO AMIR'Oo For\n Providing Me A List Of Commands "
        time.sleep(5)
        print
        '3. SPECIALLY IDEA & CREADTED BY TECH QAISER'
        time.sleep(5)
