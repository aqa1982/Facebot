...
def menu():
    ...
    print
    '\x1b[1;96mAUTHOR  : NAHID HASAN '
    print
    '\x1b[1;96mYOUTUBE: TOXIC NAHID'
    print
    '\x1b[1;96mGITHUB  : github.com/NAHID-AFRIDY'
    print
    ''
    print
    50 * '-'
    ...
    print
    print
    '\x1b[1;96mBANGLADESH ALL OPERETOR NETWORK'
    print
    print
    '\x1b[1;96m[1]   GRAMEEN PHONE(NAHID CLONER BEST)'
    print
    '\x1b[1;91m[2]  AIRTEL(5G-ST)'
    print
    '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print
    '\x1b[1;93m[4]  BANGLALINK(NEW)'
    print
    '\x1b[1;94m[5]  ROBI(5G-ST)'
    print
    '\x1b[1;95m[6]  TELETALK(5G-ST)'
    print
    '\x1b[1;96m[7]  EXIT'
    print
    '\x1b[1;96m[0]  EXIT'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print
                '\x1b[1;92m[NAHID_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print
                '\x1b[1;96m[NAHID_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [khankir pola 7 din por login dibi]\x1b[0m \n'
