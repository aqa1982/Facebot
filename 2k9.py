...
\033[1;96    ████   ███████ ██   ██  ██      ██ ██   ██  
             ....... OSAMA-1982 ......
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : OSAMA-1982
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : OSAMA-ZAMZAM 
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : AQA-1982
...
\033[1;90m══════════════════════════════════════════════════
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s[>_] [BY] : %s/%s -> \033[0;92m [ txt-OK:%s ]- \033[0;91m[txt-CP:%s ]" % (
...
if len(sys.argv) == 2:
    if sys.argv[1] == "--info":
        ...
        print("\n [*] Author    : OSAMA-1982")
        print(" [*] Team      : BLACK OSAMA TEAM \n")
        print(" [ Sosial Medi  ] \n")
        print(" [*] Facebook  :https://www.facebook.com/profile.php?id=100024557781911")
        print(" [*] Instagram :")
        print(" [*] YouTube   : https://www.facebook.com/profile.php?id=100024557781911")
        exit(" [*] GitHub    : https://www.facebook.com/profile.php?id=100024557781911")
    else:
        Main()
